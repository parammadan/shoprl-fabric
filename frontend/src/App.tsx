...
import JobsQueue from "./panels/JobsQueue";
import Policies from "./panels/Policies";
import Checkpoints from "./panels/Checkpoints";
import Trajectories from "./panels/Trajectories";
    ...
    <div className="flex h-screen">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          ...
          {view === "jobs" && <JobsQueue live={live} />}
          {view === "policies" && <Policies live={live} />}
          {view === "checkpoints" && <Checkpoints live={live} />}
          {view === "trajectories" && <Trajectories live={live} />}
          {view === "recovery" && <Recovery live={live} />}
        </main>
      </div>
    </div>
  );
